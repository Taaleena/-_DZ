...
int numPlan = 3;           // оси координат
int min = 0;               // минимальное значение диапазона для выбора случайных чисел
int max = 13;              // максимальное значение диапазона ...
...
System.Console.Write($"точка А: ");
PrintCoords(PointA);
System.Console.Write($"точка B: ");
PrintCoords(PointB);
